    ...
    return (
        <div className={cx('fr-stats-panel')}>
            ...
            <div className={cx('fr-stats-panel__item')}>
                ...
                <div className={cx('fr-stats-panel__stats')}>
                    <span className={cx('fr-stats-panel__stats-value')}>192 821</span>
                    <span className={cx('fr-stats-panel__stats-value fr-stats-panel__stats-value--purple')}>1241</span>
                    <span className={cx('fr-stats-panel__stats-value fr-stats-panel__stats-value--yellow')}>9124</span>
                    <span className={cx('fr-stats-panel__stats-value fr-stats-panel__stats-value--red')}>37 888</span>
                    <span className={cx('fr-stats-panel__stats-value fr-stats-panel__stats-value--green')}>87 125</span>
                </div>
            </div>
            <div className={cx('fr-stats-panel__item')}>
